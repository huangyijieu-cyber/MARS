...
# --- Path Configuration ---
FAISS_DB_DIR = "data/source_data/faiss_kb"                                # Knowledge base path
TEST_FILE_PATH = "data/test/MolPuzzle_all_test_fps_selfies_threshold_0.2.tsv"  # Test data path
OUTPUT_FILE_PATH = "results/MARS.csv"                                           # Output result path

# --- Parameter Configuration ---
MCTS_ITERATIONS = 20              # Number of MCTS iterations
...
MAX_TEST_SAMPLES = 100            # Test sample limit, set to None for unlimited
PWORKERS = 20                     # Number of parallel workers, adjust based on CPU cores

# === Docker Container Pool Configuration (New) ===
DOCKER_CPUS = 1.5                                    # Number of CPUs allocated per Docker container
DOCKER_MEM = "8g"                                    # Memory size allocated per Docker container                                 
